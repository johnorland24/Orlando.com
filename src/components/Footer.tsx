    ...
    <div className='dark'>
        <footer className='bg-zinc-50 dark:bg-black text-zinc-700 dark:text-zinc-400 text-sm z-20'>
            ...
            <div className='w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 py-24 flex flex-col sm:flex-row gap-10 justify-between'>
                ...
                <span className='font-bold text-2xl text-white'>Orlando.com</span>
            </a>
                    <p className="leading-relaxed my-6">MIT Licensed<br/>Copyright © 2024 John orland Sudoy Inc.</p>
                    <div className="flex items-center gap-4">
                        <a className="generic-hover" href="https://github.com/johnorland24">
